...
class PkgConfig(object):
    ...
    def __init__(self, cfg):
        ...
        if self.TARGET in ["pynq", "ultra96", "te0802", "zcu104"]:
        ...
        elif self.TARGET == "te0802":
            self.fpga_device = "xczu2cg-sbva484-1-e"
            self.fpga_family = "zynq-ultrascale+"
            self.fpga_board = "trenz.biz:te0802_2cg_1e:part0"
            self.fpga_board_rev = "2.0"
            self.fpga_freq = 333
            self.fpga_per = 2
            self.fpga_log_axi_bus_width = 7
            self.axi_prot_bits = '010'
